...
if (jQuery)(function(c) {
	function e(a) {
		a = c.extend({}, k, a);
		for (var f = c(this), g = 0, e = f.length; g < e; g++) {
			var d = f.eq(g),
				b = a;
			d.data("naver") || (c.extend(b, d.data("naver-options")), b.labelClosed = d.data("label-closed") || b.labelClosed, b.labelOpen = d.data("label-open") || b.labelOpen, b.animated && d.addClass("animated"), d.addClass("naver").wrapInner('<div class="naver-container" />').wrapInner('<div class="naver-wrapper" />').prepend('<span class="naver-handle">' + (b.label ? b.labelClosed : "") + "</span>"), b = c.extend({
				$nav: d,
				$container: d.find(".naver-container"),
				$wrapper: d.find(".naver-wrapper"),
				$handle: d.find(".naver-handle")
			}, b), b.$nav.on("touchstart.naver mousedown.naver", ".naver-handle", b, l).on("open.naver", b, m).on("close.naver", b, n).data("naver", b), h.activate.apply(b.$nav))
		}
		return f
	}
	...
	function m(a) {
		a = a.data;
		a.$wrapper.css({
			height: a.$container.outerHeight(!0)
		});
		a.$nav.addClass("open");
	...
	c.fn.naver = function(a) {
		return h[a] ? h[a].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" !== typeof a && a ? this : e.apply(this, arguments)
	}
})(jQuery);